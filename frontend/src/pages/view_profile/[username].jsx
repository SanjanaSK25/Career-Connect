...
import { getConnectionsRequest, getMyConnectionRequets, sendConnectionRequest } from '@/config/redux/action/authAction';
...
export default function ViewProfilePage({ userProfile }) {
    ...
    const getUsersPost = async () => {
        ...
        await dispatch(getMyConnectionRequets({ token: localStorage.getItem("token")  }))
    }
                            ...
                            <div style={{flex: "0.8"}}>
                                ...
                                <div style={{display: "flex", alignItems: "center", gap: "1.2rem"}}>
                                    ...
                                    <div onClick={ async () => {
                                        ...
                                        <svg style={{height: "1.2em"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
