            ...
            <DashboardLayout>
                <div className={styles.scrollComponent}>
                    ...
                    <div className={styles.wrapper}>
                        ...
                        <img className={styles.userProfile} src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="profile pic" />
                            ...
                            return (
                                <div key={post._id} className={styles.singleCard}>
                                    <div className={styles.singleCard_profileContainer}>
                                        <img className={styles.userProfile} src={`${BASE_URL}/${post.userId.profilePicture}`} alt="profile pic" />
                                        <div>
                                            ...
                                            <div className={styles.optionsContainer}>
                                                ...
                                                <div onClick={async () => {
                                                    ...
                                                    <p style={{color: "grey"}}>{post.likes}</p>
                                                </div>
