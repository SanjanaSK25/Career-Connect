            ...
            <div className={styles.container}>
...

                {
                    ...
                    className={styles.commentsContainer}>
                        ...
                        <input onChange={handleWorkInputChange} name='position' className={styles.inputField} type='text' placeholder='Enter Role'></input>
                ...
                
                {
                    ...
                    className={styles.commentsContainer}>
                        ...
                        <input onChange={handleWorkInputChange} name='school' className={styles.inputField} type='text' placeholder='Enter School / College'></input>
                        <input onChange={handleWorkInputChange} name='degree' className={styles.inputField} type='text' placeholder='Enter Degree / Course'></input>
                        <input onChange={handleWorkInputChange} name='fieldOfStudy' className={styles.inputField} type='text' placeholder='Enter Field of Study'></input>
